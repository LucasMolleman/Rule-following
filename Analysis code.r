...
### DESCRIPTIVES (TABLE S1 shows the key demographic variables here) #######
...
stargazer(m1_normative, m1_descriptive, m1_combined, type="html", ci=TRUE, ci.level=0.95, title="", align=TRUE, single.row=TRUE, star.cutoffs=c(0.05,0.01,0.001), out="Table S3.html")
